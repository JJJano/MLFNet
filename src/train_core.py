...
def parse_args():
    ...
    parser.add_argument('--lambda_sym_cor', type=float, default=0.01)
    ...
    parser.add_argument('--lambda_x_mask', type=float, default=1.0)
    parser.add_argument('--lambda_obj_depth', type=float, default=10.0)
    parser.add_argument('--lambda_obj_normal', type=float, default=1.0)
    parser.add_argument('--object_name', type=str, default='ape')
    parser.add_argument('--dataset', type=str, default='linemod', choices=['occlusion_linemod', 'occlusion_linemod'])
...
if __name__ == '__main__':
    ...
    trainer.generate_data(val_loader,epoch=args.n_epochs)
